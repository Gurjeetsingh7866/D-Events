...
public class joinclub_model {
    ...
    public joinclub_model() {
    }

    public joinclub_model(String club_id, String clubpuchid, String club_name, String date_club, String description) {
